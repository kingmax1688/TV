...
CHANNEL_CATEGORIES = {
    "央视频道": [
        ...
        "CCTV-4K超高清", "CCTV-8K超高清", "CCTV-兵器科技", "CCTV-风云音乐", "CCTV-风云足球", "CCTV-风云剧场", "CCTV-怀旧剧场", "CCTV-第一剧场", "CCTV-女性时尚", "CCTV-世界地理", 
        "CCTV-央视台球", "CCTV-高尔夫网球", "CCTV-央视文化精品", "CCTV-卫生健康", "CCTV-电视指南", "中央新影-老故事", "中央新影-中学生", "中央新影-发现之旅", "书法频道", "国学频道", "环球奇观",
    ...
    "体育频道": [
        ...
        "睛彩广场舞", "魅力足球", "纬来体育", "澳门体育", "快乐垂钓", "四海钓鱼", "先锋乒羽", "天元围棋", "汽摩", "车迷频道", "游戏风云", "网络棋牌", "安徽综艺体育", 
    ],
    "数字影视": [
    ...
    "港澳台频道": [
        "凤凰中文", "凤凰资讯", "凤凰香港", "凤凰电影", "龙祥时代", "星空卫视", "CHANNEL[V]", "澳视澳门", "澳门莲花", "TVB星河", "东森超视",
        "东森综合", "私人影院", "DMAX", "动物星球", "ANIMAX", "TVB翡翠台", "TVB明珠台",
    ],
    "少儿频道": [
...
CHANNEL_MAPPING = {
    ...
    "CCTV-5+ 体育赛事": ["CCTV5+", "CCTV-5+", "CCTV5+体育赛事", "CCTV5+高清", "CCTV5+HD", "cctv5+", "CCTV5plus","CCTV5+体育赛事高清"],
